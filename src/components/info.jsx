  ...
  return (
    <section className="info">
      <div className="info__wrapper">
        <p className="info__text">Версия программы 1.3.1</p>
        <p className="info__text">Изменения:</p>
        <p className="info__text">
          Пользовательские изменения:<br />
          - Убран вентилятор ZFR 1,9-2E.<br />
          - Все частотные преобразователи заменены на серию Z-NK.<br />
          - Маркировка регулятора скорости SRE теперь выделяется жирным текстом в ТКП.<br />
          - Случайная строка в названии файлов технических листов заменена на порядковый номер при дублировании названий.<br />
          - Обновлён шаблон ТКП (шапка).<br />
        </p>
        <p className="info__text">
          Исправления:<br />
          - Исправлено: Пересчёт системы при выборе и последующем выходе из результатов расчёта.<br />
        </p>
